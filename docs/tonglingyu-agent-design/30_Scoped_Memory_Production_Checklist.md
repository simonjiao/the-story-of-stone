...
- 2026-05-19 本地验证通过：`cargo test --workspace`、`cargo clippy --workspace
  ...
  `../tonglingyu-gatekeeper/deploy/scripts/verify-tonglingyu-rqa-user-lifecycle.sh`、
  `../tonglingyu-gatekeeper/deploy/scripts/verify-tonglingyu-rqa-backup-restore-drill.sh`、
