...
- 最新完整远端 release automation
  ...
  clean-worktree blocker 已消失；`openwebui_browser_review` 通过，open P0
  retrieval failures / governance tasks 均为 0。当前 required failures 只剩
  `security_scan` 和 `release_ops_readiness`。
