...
- 2026-05-16 已新增 `tonglingyu-rqa-lifecycle-v1` 和
  ...
  batch tombstone。
- 仍不能宣布 J 完成或整体 RQA production-ready：backup/restore 演练、RTO/RPO、
  restore 后 gate 复核、production report 引用保留、live release 证据、安全扫描、
  性能预算和 lifecycle contract smoke 仍未闭合。
