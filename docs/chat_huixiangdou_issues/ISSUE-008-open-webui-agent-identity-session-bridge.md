...
已完成。独立完整方案见 `docs/OPEN_WEBUI_AGENT_IDENTITY_BRIDGE_PLAN.md`，实现 checklist 见 `docs/OPEN_WEBUI_AGENT_IDENTITY_BRIDGE_IMPLEMENTATION_CHECKLIST.md`。后续只保留常规回归：Open WebUI Function 管理接口可用性、Function secret 轮换、历史搜索和停止按钮可访问性分别由其他 issue 跟踪。
