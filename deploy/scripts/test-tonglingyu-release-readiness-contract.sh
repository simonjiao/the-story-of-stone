...
gate_stdout = {
    ...
    "rqa_backup_restore_drill": {
        ...
        "artifacts": {
            ...
            "restored_memory_read_sha256": "a" * 64,
        ...
        "checks": {
            ...
            "scoped_memory_backup_restored": True,
            "scoped_memory_read_path_restored": True,
        },
        "drill_result": "passed",
        "duration_ms": 4000,
        "environment": "production",
    ...
    "rqa_user_lifecycle": {
        ...
        "checks": {
            ...
            "scoped_memory_anonymize_disabled_reads": True,
            "scoped_memory_lifecycle_counts_present": True,
            "scoped_memory_traceability_preserved": True,
