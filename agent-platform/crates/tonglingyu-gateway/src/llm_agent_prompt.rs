...
use crate::{
    ...
    question_frame::QUESTION_FRAME_SCHEMA_VERSION,
};
...
fn question_normalizer_input_context(payload: &Value) -> Result<Value> {
    Ok(json!({
        ...
        "allowed_rule_candidate_types": required_field(payload, "allowed_rule_candidate_types")?,
    }))
}
                ...
                "properties": {
                    ...
                    "rule_candidates": {
                        ...
                        "items": {
                            "type": "object",
                            "additionalProperties": false,
                            "required": ["candidate_type", "term", "reason"],
                            "properties": {
